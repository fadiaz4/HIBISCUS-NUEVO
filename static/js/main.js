    ...
    if (user !== null && user !== "") {
        if (password !== null && password !== "") {
            ...
            if (canLogin === true) {
                ...
                if (role == "admin") {
                    window.location.href = "http://127.0.0.1:5000/dashboardadmin";
                    //window.location.href = "https://hibiscussv.herokuapp.com/dashboardadmin";
                } else {
                    window.location.href = "http://127.0.0.1:5000/dashboardclient";
...
function registerNewUser() {
    ...
    //window.location.href = "https://hibiscussv.herokuapp.com/login-hsv";
}
